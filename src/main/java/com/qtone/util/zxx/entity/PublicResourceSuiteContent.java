...
public class PublicResourceSuiteContent {
    private Integer id;
    ...
    public String getZxxUrl() {
        return zxxUrl;
    }

    public void setZxxUrl(String zxxUrl) {
        this.zxxUrl = zxxUrl == null ? null : zxxUrl.trim();
    }
